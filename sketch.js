...
//Call functions to detect collision for player and computer
  Matter.SAT.collides(playerArcher, computerArcher)
}
...
Matter.Collision.collides(playerArrows, computerArcher, [pairs])
}

function handleComputerArrowCollision() {
  //Write code to detect collision between computer arrow and opponent
  Matter.Collision.collides(computerArrows, playerArcher, [pairs])
}
